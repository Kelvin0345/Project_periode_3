    ...
    <div class="container">
        ...
        <form method="GET">
            ...
            <div class="filter-bar">
                <input type="text" name="zoek" placeholder="Zoek lesnaam..."
            ...
            <div class="price-filter">
                ...
                <div class="price-content" id="priceContent">
                    ...
                    <div class="sort-options">
                        <label><input type="radio" name="sort" value="" <?php if ($sort == "")
                            echo "checked"; ?>>
                            Aanbevolen</label>
                        <label><input type="radio" name="sort" value="laag-hoog" <?php if ($sort == "laag-hoog")
                            echo "checked"; ?>> Prijs laag - hoog</label>
                        <label><input type="radio" name="sort" value="hoog-laag" <?php if ($sort == "hoog-laag")
                            echo "checked"; ?>> Prijs hoog - laag</label>
                    </div>
