...
");
// dit zijn de pakketten die in de database worden gezet, zodat er iets te tonen is op de website.
//  In een echte situatie zou dit via een admin panel moeten gebeuren, maar voor deze demo zetten we ze direct in de code.
$conn->query("
...
// dit is de zoekfunctie, hiermee kunnen gebruikers zoeken op lesnaam. 
// De zoekterm wordt veilig gemaakt met real_escape_string om SQL-injectie te voorkomen.
$zoek = "";
...
// dit is de CSS-styling voor de website, het zorgt ervoor dat de website er netjes en overzichtelijk uitziet.
<style>
