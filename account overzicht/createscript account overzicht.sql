...
VALUES
('Jan', NULL, 'van der Berg', 2001, '0612345678', 'jan.vanderberg@email.nl', 1, NULL, '2026-03-05', NOW(6)),
('Emma', NULL, 'Jansen', 2002, '0623456789', 'emma.jansen@email.nl', 1, NULL, '2026-03-05', NOW(6)),
('Pieter', NULL, 'de Vries', 2003, '0634567890', 'pieter.devries@email.nl', 0, NULL, '2026-03-05', NOW(6)),
('Sophie', NULL, 'Bakker', 2004, '0645678901', 'sophie.bakker@email.nl', 1, NULL, '2026-03-05', NOW(6)),
('Thomas', NULL, 'Visser', 2005, '0656789012', 'thomas.visser@email.nl', 1, NULL, '2026-03-05', NOW(6)),
('Lisa', NULL, 'Smit', 2006, '0667890123', 'lisa.smit@email.nl', 1, NULL, '2026-03-05', NOW(6));